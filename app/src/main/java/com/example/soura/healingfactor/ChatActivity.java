...
{
    private CircleImageView ProfileImage,LocationImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocationImage=(CircleImageView)findViewById(R.id.custom_bar_locator);

        LocationImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Intent profileIntent = new Intent(ChatActivity.this,MapsActivity.class);
